...
psql \
  ...
  -U postgres \
  -d bewerbungswebsite \
  -f /migrations/self-hosted/040_match_analysis_job_context_retention.sql
...
values
  ...
  ('040_match_analysis_job_context_retention', '/migrations/self-hosted/040_match_analysis_job_context_retention.sql')
